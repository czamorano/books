package es.imserso.books.web.rest;

import es.imserso.books.config.Constants;
import es.imserso.books.BooksApp;
import es.imserso.books.domain.Authority;
import es.imserso.books.domain.User;
import es.imserso.books.repository.AuthorityRepository;
import es.imserso.books.repository.UserRepository;
import es.imserso.books.security.AuthoritiesConstants;
import es.imserso.books.service.MailService;
import es.imserso.books.service.dto.UserDTO;
import es.imserso.books.service.dto.PasswordChangeDTO;
import es.imserso.books.web.rest.errors.ExceptionTranslator;
import es.imserso.books.web.rest.vm.KeyAndPasswordVM;
import es.imserso.books.web.rest.vm.ManagedUserVM;
import es.imserso.books.service.UserService;
