package es.imserso.books.repository;

import es.imserso.books.BooksApp;
import es.imserso.books.config.Constants;
import es.imserso.books.config.audit.AuditEventConverter;
import es.imserso.books.domain.PersistentAuditEvent;
...
import static es.imserso.books.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
