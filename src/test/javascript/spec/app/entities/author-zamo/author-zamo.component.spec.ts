...
import { AuthorZamoComponent } from 'app/entities/author-zamo/author-zamo.component';
...
describe('Component Tests', () => {
    describe('AuthorZamo Management Component', () => {
        let comp: AuthorZamoComponent;
        let fixture: ComponentFixture<AuthorZamoComponent>;
        let service: AuthorZamoService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [BooksTestModule],
                declarations: [AuthorZamoComponent],
                providers: [
                    {
                ...
                .overrideTemplate(AuthorZamoComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(AuthorZamoComponent);
