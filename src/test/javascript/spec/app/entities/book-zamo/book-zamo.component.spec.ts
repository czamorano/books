...
import { BookZamoComponent } from 'app/entities/book-zamo/book-zamo.component';
...
describe('Component Tests', () => {
    describe('BookZamo Management Component', () => {
        let comp: BookZamoComponent;
        let fixture: ComponentFixture<BookZamoComponent>;
        let service: BookZamoService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [BooksTestModule],
                declarations: [BookZamoComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BookZamoComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(BookZamoComponent);
