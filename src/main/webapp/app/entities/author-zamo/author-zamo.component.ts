...
@Component({
    selector: 'jhi-author-zamo',
    templateUrl: './author-zamo.component.html'
})
export class AuthorZamoComponent implements OnInit, OnDestroy {
    authors: IAuthorZamo[];
    currentAccount: any;
    ...
    loadAll() {
        this.authorService
            ...
            .subscribe(
                (res: HttpResponse<IAuthorZamo[]>) => this.paginateAuthors(res.body, res.headers),
    ...
    trackId(index: number, item: IAuthorZamo) {
        return item.id;
    }
    ...
    private paginateAuthors(data: IAuthorZamo[], headers: HttpHeaders) {
